// hermes-engine/src/temporal_types.rs — data types for the temporal facts system.
...
/// Extended inputs for recording a fact.
...
/// Filter parameters for `get_active_facts`.
#[derive(Default)]
