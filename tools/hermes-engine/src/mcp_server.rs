...
//        hermes_validate_env, hermes_check_consistency
    ...
    json!({
        "tools": [
            ...
            },
            {
                ...
                "description": "Validate an environment variable name against the config_registry populated during hermes_index. Returns valid:true when the name is known, or valid:false with the 5 closest suggestions (Levenshtein).",
                "inputSchema": {
                    "type": "object",
